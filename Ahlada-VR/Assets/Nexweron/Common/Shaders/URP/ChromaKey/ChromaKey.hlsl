...
// SHADER GRAPH
// Alpha
void ApplyChromaKeyAlpha_half(half4 baseRGBA, half3 keyRGB, half dChroma, half dChromaT, half dLuma, half dLumaT, int colorSpace, out half4 result) {
    if (colorSpace == 0) {
        result = ApplyChromaKeyAlphaYCbCr(baseRGBA, keyRGB, dChroma, dChromaT, dLuma, dLumaT);
    }
    else {
        result = ApplyChromaKeyAlphaYIQ(baseRGBA, keyRGB, dChroma, dChromaT, dLuma, dLumaT);
    }
}

void ApplyChromaKeyAlphaYCbCr_half(half4 baseRGBA, half3 keyRGB, half dChroma, half dChromaT, half dLuma, half dLumaT, out half4 result) {
    result = ApplyChromaKeyAlphaYCbCr(baseRGBA, keyRGB, dChroma, dChromaT, dLuma, dLumaT);
}

void ApplyChromaKeyAlphaYIQ_half(half4 baseRGBA, half3 keyRGB, half dChroma, half dChromaT, half dLuma, half dLumaT, out half4 result) {
    result = ApplyChromaKeyAlphaYIQ(baseRGBA, keyRGB, dChroma, dChromaT, dLuma, dLumaT);
}

// Bg
void ApplyChromaKeyBg_half(half4 baseRGBA, half3 keyRGB, half4 bgRGBA, half dChroma, half dChromaT, half chroma, half luma, half saturation, half alpha, int colorSpace, out half4 result) {
    result = ApplyChromaKeyBgYCbCr(baseRGBA, keyRGB, bgRGBA, dChroma, dChromaT, chroma, luma, saturation, alpha);
}

void ApplyChromaKeyBgYCbCr_half(half4 baseRGBA, half3 keyRGB, half4 bgRGBA, half dChroma, half dChromaT, half chroma, half luma, half saturation, half alpha, out half4 result) {
    result = ApplyChromaKeyBgYCbCr(baseRGBA, keyRGB, bgRGBA, dChroma, dChromaT, chroma, luma, saturation, alpha);
}
